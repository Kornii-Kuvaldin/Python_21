...
class Game21:
    ...
    def deal_initial_cards(self):
        ...
        #print("Player:", self.game.player_hand, "Dealer:", self.game.dealer_hand)

    # DECK AND CARD DRAWING

    def create_deck(self):
        """
        Create a standard 52-card deck as codes matching image filenames:
        AS, 10H, KD, 2C, etc.
    ...
    def hand_total(self, hand):
        ...
        ace_count = sum(1 for card in hand if card[:-1] == "A")
                                                                 #changed from rank check to not crash
        # Bust handling
